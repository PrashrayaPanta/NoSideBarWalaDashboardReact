    ...
    <header>
      <div className="bg-black flex justify-between px-8 py-2 items-center">
        ...
        <div className="flex gap-5 items-center text-xl text-white">
          ...
          <a href="/post" className="items-center lg:flex hidden">
            <svg
          ...
          <a href="/login" className="items-center lg:flex hidden">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 640"
          ...
          <a href="/register" className="items-center lg:flex hidden">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 640"
              className="w-5 fill-white"
        ...
        <div className="text-white relative hidden lg:block">
          <a href="#" className="flex items-center" onClick={handleUserSetting}>
            {/* User Icon */}
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 640"
          ...
          {openUserSetting && (
            <div className="absolute top-8 right-0 -left-12 rounded-sm px-2 py-2 bg-black">
              {/* Edit Profile */}
              <a href="/profile/edit" className="flex items-center pb-2">
                {/* Edit Profile Icon */}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 640 512"
      ...
      {hambergerMenu && (
        <>
          ...
          <div className="flex gap-5 items-center text-xl overflow-scroll px-8 py-3 lg:py-0">
            ...
            <a href="/category" className="flex items-center lg:hidden">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 640 640"
                width="20"
